...
rstep provides a workflow to automate various tasks when performing 1D or 2D STEP simulations [(Mougin et al. 1995)](https://www.sciencedirect.com/science/article/abs/pii/0034425794001268). It prepares the model input data, runs the model in R, and automates the visualization of the model results.
